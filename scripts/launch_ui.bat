...
REM running, then opens the UI at http://localhost:8501. No Google login needed - a real
REM (even signed-out) Chrome is what beats anti-bot sites. Close this window to stop.
cd /d "%~dp0.."
...
echo (A Chrome window may open for hard sites - just leave it open. No login needed.)
